...
export default function PWKde() {
    ...
    return (
        <main
            className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100 px-4 sm:px-8 py-16">
            <section className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-bold text-teal-400 mb-6">PlaywithK.de Netzwerk</h1>
                <p className="text-gray-300 mb-8">
                    Das Winterprojekt ist eines meiner liebsten Minecraft-Projekte, bei dem ich eine verschneite
                    Landschaft mit detailreichen Bauten erschaffen habe.
                    Ziel war es, eine gemütliche Winterwelt mit vielen kleinen Details zu gestalten.
                </p>

                <div
                    className="relative w-full h-64 sm:h-80 md:h-96 mb-8 rounded-xl shadow-lg border border-white border-opacity-10 overflow-hidden">
                    <Image
