...
export default function Projekte() {
    const {t, common, locale} = usePageBasics("projects");
    const getTags = (key) => {
    ...
    return (
        <>
                ...
                >
                    ...
                    <div className="mt-6 p-4 bg-gray-700 rounded-xl text-gray-300 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <Link
                                href={`/${locale}/projects/gamedev/numble`}
                                className="text-teal-300 text-sm underline"
                            >
                                {common("buttons.learnMore")} ➔
                            </Link>
            ...
            <section className="max-w-6xl mx-auto mt-16 px-4 sm:px-8 sm:pb-8">
                ...
                <span
                    className="text-white text-3xl sm:text-4xl font-semibold text-center drop-shadow-lg pointer-events-none">
